<template>
    <div class="row">
      <containerIB imgUrL="home/5.png" opacity="0.2" classes="containerClasses">
         <div class="mainContainer">
            <div class="subContainer" v-for="(item, index) in icons_array" :key="index">
                <h3 :class="item[0].classes">{{item[0].text}}</h3>
                <Icons :iconName="item[2].iconName" :iconType="item[2].type" iconClass="circle-icon logoIcons fa-1x"
                />
